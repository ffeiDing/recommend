...
def loadData(cur_list):
    ...
    for i in range(len(book)):
        if idx > 4999:
            break
        if "馆际" in name[i] or "耳机" in name[i] or "教程" in name[i] or "指导" in name[i] or "引论" in name[i] or "数学分析" in name[i] or "高等代数" in name[i] or "考试" in name[i] or "报" in name[i] or "刊" in name[i] or "原理" in name[i] or "选编" in name[i] or "党" in name[i] or "应用" in name[i]:
            continue
        idx += 1
...
if __name__ == "__main__":
    ...
    user = "root"   #  用户名
    month_list = ["202110", "202111", "202112", "202201", "202202", "202203", "202204", "202205", "202206", "202207", "202208", "202209", "202210", "202211", "202212", "202301", "202302"]
