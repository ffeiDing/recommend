...
def recommend_by_all_user(data, W, k=3, N=10):
    ...
    save_dic("data/recommend_202204.pkl", recommend)
    return
...
if __name__ == "__main__":
    ...
    if load_data:
        data = load_dic("data/data_202204.pkl")
        W = load_dic("data/W_202204.pkl")
    else:
        cur_list = []
        ...
        save_dic("data/data_202204.pkl", data)
        W = similarity(data)  # 计算图书相似矩阵
        save_dic("data/W_202204.pkl", W)
        print("---已保存数据---")
