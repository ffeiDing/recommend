...
def recommend_by_all_user(data, W, k=3, N=10):
    ...
    save_dic("data/recommend_202112.pkl", recommend)
    return
...
if __name__ == "__main__":
    ...
    user = "root"   #  用户名
    month_list = ["202110", "202111", "202112"]
    password = "284284dfl" # 密码
    database =  "userlog_20211020" # 数据库名称
    if load_data:
        data = load_dic("data/data_202112.pkl")
        W = load_dic("data/W_202112.pkl")
    else:
        cur_list = []
        ...
        save_dic("data/data_202112.pkl", data)
        W = similarity(data)  # 计算图书相似矩阵
        save_dic("data/W_202112.pkl", W)
        print("---已保存数据---")
